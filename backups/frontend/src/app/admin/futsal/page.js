          ...
          <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden animate-fade-in">
            ...
            <form onSubmit={handleSaveTeam} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2">
                  <label className="block text-[10px] font-bold text-gray-400 uppercase mb-1">Foto Representativa (URL)</label>
                  <input type="text" value={teamForm.imageUrl} onChange={e => setTeamForm({...teamForm, imageUrl: e.target.value})} className="w-full p-2.5 border border-gray-250 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-jn-red" placeholder="https://example.com/team.jpg" />
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl w-full max-w-xl shadow-2xl overflow-hidden animate-fade-in">
            ...
            <form onSubmit={handleSavePlayer} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2">
                  <label className="block text-[10px] font-bold text-gray-400 uppercase mb-1">Foto de Perfil (URL)</label>
                  <input type="text" value={playerForm.photoUrl} onChange={e => setPlayerForm({...playerForm, photoUrl: e.target.value})} className="w-full p-2.5 border border-gray-250 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-jn-red" placeholder="https://example.com/photo.jpg" />
                </div>
                <div className="col-span-2">
                  <label className="block text-[10px] font-bold text-gray-400 uppercase mb-1">Video Destacado (URL)</label>
                  <input type="text" value={playerForm.videoUrl} onChange={e => setPlayerForm({...playerForm, videoUrl: e.target.value})} className="w-full p-2.5 border border-gray-250 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-jn-red" placeholder="https://youtube.com/watch?v=..." />
                </div>
              </div>
              <div className="border-t border-gray-150 pt-4 flex justify-end gap-2 text-xs">
        ...
        <div className="fixed inset-0 bg-black/55 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl overflow-hidden animate-fade-in">
            ...
            <form onSubmit={handleSaveMedia} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-[10px] font-bold text-gray-400 uppercase mb-1">URL del Recurso</label>
                <input type="text" value={mediaForm.url} onChange={e => setMediaForm({...mediaForm, url: e.target.value})} className="w-full p-2.5 border border-gray-250 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-jn-red" placeholder="https://example.com/image.jpg" required />
              </div>
              <div>
        ...
        <div className="fixed inset-0 bg-black/55 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl overflow-hidden animate-fade-in">
            ...
            <form onSubmit={handleSaveNews} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-[10px] font-bold text-gray-400 uppercase mb-1">Imagen (URL)</label>
                <input type="text" value={newsForm.imageUrl} onChange={e => setNewsForm({...newsForm, imageUrl: e.target.value})} className="w-full p-2.5 border border-gray-250 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-jn-red" placeholder="https://example.com/news.png" />
              </div>
              <div>
