...
export default function MisCuotasSocio() {
  ...
  const fetchProfileAndPayments = useCallback(async () => {
    ...
    try {
      ...
      // Fallback a datos mock si no hay token o la llamada falla
      if (!token) {
        setSocio({
          id: 99,
          firstName: "Juan",
        ...
        setPayments([
          { id: 101, plan: { nombre: 'Cuota Social Julio 2026' }, importe: 4500.00, estado: 'PENDIENTE', createdAt: '2026-07-01T12:00:00Z', metodoPago: 'MERCADOPAGO' },
          { id: 102, plan: { nombre: 'Cuota Social Junio 2026' }, importe: 4500.00, estado: 'PAGADO', createdAt: '2026-06-01T12:00:00Z', metodoPago: 'EFECTIVO', invoices: [{ id: 9, numero: 'REC-000854' }] },
          { id: 103, plan: { nombre: 'Matrícula Futsal 2026' }, importe: 8000.00, estado: 'PAGADO', createdAt: '2026-05-15T12:00:00Z', metodoPago: 'TRANSFERENCIA', invoices: [{ id: 8, numero: 'REC-000732' }] }
        ]);
        setPaymentMethods([
